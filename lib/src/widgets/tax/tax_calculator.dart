import 'package:ctc_calculator/src/widgets/tax/tax_calculator_service.dart';
...
class _TaxCalculatorFormState extends State<TaxCalculatorForm> {
  ...
  void _handleCalculate() async {
    ...
    try {
      ...
      Map<String, dynamic> result2024 = TaxCalculationService.calculateTax2024(income);
      Map<String, dynamic> result2025 = TaxCalculationService.calculateTax2025(income);
