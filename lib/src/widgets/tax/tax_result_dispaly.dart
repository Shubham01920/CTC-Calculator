  ...
  Widget _buildComparisonTable() {
    return Table(
      ...
      children: [
        ...
        // Data rows
        _buildTableRow("Gross Income", result2024['grossIncome'], result2025['grossIncome']),
        _buildTableRow("Standard Deduction", result2024['standardDeduction'], result2025['standardDeduction']),
        _buildTableRow("Taxable Income", result2024['taxableIncome'], result2025['taxableIncome']),
        _buildTableRow("Tax Amount", result2024['tax'], result2025['tax']),
        _buildTableRow("Net Income", result2024['netIncome'], result2025['netIncome']),
        _buildTableRow("Effective Rate (%)", result2024['effectiveRate'], result2025['effectiveRate']),
      ],
    );
  }
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  isSaving ? "Tax Savings in FY 2025-26" : "Additional Tax in FY 2025-26",
                  style: AppTextStyles.custom(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
